...
API_ID = int(environ.get('API_ID', '7258573965'))
API_HASH = environ.get('API_HASH', 'AAGwd0MLgUNCo2lMQ47ThAHofoy_3vWiwHw')
...
LOG_CHANNEL = int(environ.get('-1002443841750', ''))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('6087951943', '').split()]

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1002262049006', '').split()]
...
auth_channel = environ.get('-1002483813861', '') # give your force subscribe channel id here else leave it blank
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filmove14:vUD0TsEqwsq6SvJc@cluster0.k29mz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+W6N8i94-_WRhMTll')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Max_gamer0')
